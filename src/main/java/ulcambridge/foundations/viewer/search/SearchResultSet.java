...
/**
 * Holds information for a set of results generated from a user search. Includes
 * individual SearchResults and information about the search itself.
 * 
 * @author jennie
 * 
 */
public class SearchResultSet {
	...
	public SearchResultSet(int totalDocs, String spellingSuggestedTerm,
			float queryTime, List<SearchResult> results,
			List<FacetGroup> facets, String error) {
