...
projectlight.markExternalLinks = function(){
	if (jQuery.browser.msie) {
		$("#content a[href*='cam.ac.uk']").not(".campl-carousel a[href*='http://']").not("#content a[href^='/']").addClass("campl-external").attr({
			"title": $(this).attr("title")+" (Link to an external website)"
		})	
	}else{
		$('#content a').not(".campl-carousel a").not("#content a[href^='/']").filter(function(){
