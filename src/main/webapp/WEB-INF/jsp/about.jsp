			...
			<h3 style="margin-left:8px">Introducing the Cambridge Digital Library</h3>
				...
				<div class="grid_11">
					...
					<p>Over the course of six centuries Cambridge University
						...
						conceivable aspect of human endeavour, spanning millennia and most
						of the world's cultural traditions. While parts of the Library's
					...
					<p><b>The Foundations of Faith Collection</b> will include important
						...
						manuscripts, and the Book of Dear and Book of Cerne. Among the
					...
					<p><b>The Foundations of Science Collection</b> will focuses on
						...
						collection, the Library holds the papers of Charles Darwin, Lord
						Kelvin, Adam Sedgwick, J.J. Thomson, Ernest Rutherford, James
						Clerk Maxwell and Sir George Gabriel Stokes. It is also the
						repository of the Royal Greenwich Observatory archives, which
						includes the papers of the Astronomers Royal and the Board of
						Longitude papers, and the archives of Cambridge's Cavendish
						Laboratory.</p>
					...
					<p>
						...
						with scholarly research. Our first release of content, the Newton
						Papers, is a good example. We have collaborated with the <a
							href="http://www.newtonproject.sussex.ac.uk/" target="_blank">Newton
							Project</a> to provide transcriptions alongside images of Newton's
						manuscripts.
					</p>
					<p>Another goal is to make content from the Digital Library
						...
						hope to provide good quality images and texts for educational use.</p>
				</div>
			</div>
		</div>
</section>
