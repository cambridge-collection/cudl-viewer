...
<section id="content" class="grid_20 content">
	...
	<div class="grid_19 contibutors">
		...
		<div class="grid_13">
			...
			first phase of the Foundations Digital Library Project, supporting
			the development of the initial infrastructure and the digitisation of
		...
		<div class="grid_14">
			...
			<ul>
				...
				<li><a href="http://www.newtonproject.sussex.ac.uk/prism.php?id=24" target="_blank">Other
					members of the Newton Project team</a></li>
			</ul>
