...
<section id="content" class="grid_20 content">
	...
	<div class="grid_19 contibutors">
		...
		<h3>Contributors to the Cambridge Digital Library</h3>
		...
		<div class="grid_18">
			...
			<div class="grid_13">
				Under the leadership of Dr Leonard Polonsky and as part of its International Digitisation Project, The <b>Polonsky Foundation</b> has provided
				major funding towards the first phase of the Cambridge Digital Library (2010-14), enabling the development of the digital library's core infrastructure
				and the digitisation of content for its Foundation Faith and Science collections. <br />
				<br />
			</div>
		</div>
		<div class="grid_18">
			...
			<div class="grid_13">
				...
				to 18th century science and technology.<br /> <br />
			</div>
		</div>
		<div class="grid_18">
		...
		<div class="grid_18">
			...
			<div class="grid_13">
				The cataloguing and digitisation of the <a
					...
					href="/collections/spanishchapbooks">Spanish Chapbooks</a> were funded by the <b><a href="http://www.ahrc.ac.uk/"
		...
		<div class="grid_18">
			...
			<div class="grid_13">
				The <a href="http://www.neh.gov/">National Endowment for the Humanities</a> (NEH) is an independent US federal agency created by Congress in 1965 to promote "excellence in the humanities".
				It is one of the largest funders of humanities programs in the United States. NEH supported the digitisation of all items in the Charles Darwin's Evolution Manuscripts under grant no. PW-51320-13.  <br /> <br />
			</div>
		...
		<div class="grid_18">
			...
			<div class="grid_4">&nbsp;</div>
			<div class="grid_13">
				Materials for the Japanese Works collections were digitised through a generous donation by Professor Mikiko Ishii of Kanagawa University, Japan.<br /> <br /><br /> <br />
			</div>
		...
		<h4>Digital Library Leadership</h4>
		
		<ul>
			<li>Dr Ben Outhwaite, Acting Joint Head of Special Collections, Senior Programme Lead</li>
		...
		<ul>
			...
			<li>Maciej Pawlikowski, Senior Photographer and Digitisation Supervisor</li>
		...
		<ul>
			<li>Professor Simon Schaffer, Professor of the History and Philosophy of
		...
		<h4>Darwin Manuscripts</h4>
		<ul>
			<li>Professor David Kohn, Director, Darwin Manuscripts
				Project</li>
			<li>Dr Alison Pearn, Associate Director, Darwin Correspondence
				Project</li>
			<li>Professor Jim Secord, Director, Darwin Correspondence
		...
		<ul>
			<li>Catherine Ansorge, Former Joint-Head of Near and Middle Eastern
		...
		<h4>Music</h4>
		<ul>
			<li>Dr Suzanne Paul, Manuscripts Department, Cambridge University Library</li>
			<li>Anna Pensaert, Head of Music Collections, Cambridge University Library and Pendlebury Library of Music</li>
