...
<div class="grid_10">
	...
	<div class="grid_9">
		...
		<p>The volumes in the Hebrew Manuscripts Collection at Cambridge
			...
			basis for Hebrew study grew in the University from the sixteenth
		...
		<p>Notable collectors from early times include the Arabist,
			Abraham Whelock (who was the first Professor of Arabic and also
			...
			Notably, he negotiated the transfer to Cambridge of the collection of
			Thomas van Erpe (Erpenius), the noted Dutch orientalist which
			contained 13 Hebrew manuscripts and one written in Judaeo-Arabic.</p>
		<p>A second important collection was that of Isaac Faraji (Pragi)
			whose collection of 10 Hebrew manuscripts was purchased by John
