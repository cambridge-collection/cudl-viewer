...
<div class="grid_10">
	...
	<div class="grid_9">
		...
		<p>As part of the process of recataloguing and preserving the College's collections, it has been decided to present highlights from the Peterhouse manuscripts in digital form. The first group of manuscripts to be digitised was the independent collection of sixteenth- and seventeenth-century part books of choral music, which are available through the <a href='http://www.diamm.ac.uk/' target='_blank'>Digital Image Archive of Medieval Music (DIAMM)</a>. It is now hoped to present some of the College's medieval manuscripts with appropriate commentary as part of the Cambridge Digital Collections. The first manuscript selected for this purpose is the Equatorie of the Planetis (Peterhouse MS 75.I). As funding becomes available, further manuscripts will be added to the online collection.</p>
