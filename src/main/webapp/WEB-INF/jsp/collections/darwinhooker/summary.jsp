	...
	<div class="campl-column12">
		...
		<div class="campl-column6">
			<blockquote class="cam-quote-mark">
				...
				confessing a murder) immutable." <br /> <br /> <cite> <a
					href="/view/MS-DAR-00114-00003/4">Charles Darwin to Joseph
						Dalton Hooker, 11 January 1844</a></cite>

			</blockquote>
		</div>
		<div class="campl-column3">
			<img class="collectionOrganisationalImage"
				src="/images/collectionsView/darwinhooker-darwin.jpg" alt="Darwin"
				width="150" height="225" /><span class="image-credit-darwin">Charles
				Darwin</span> 
		</div>
		<div class="campl-column3">				
				<img class="collectionOrganisationalImage"
				src="/images/collectionsView/darwinhooker-hooker.jpg" alt="Darwin"
				width="150" height="225" /><br />
			<span class="image-credit-darwin">Joseph Hooker</span>
		</div>
	</div>
	<div class="campl-column12">
		...
		<p>Cambridge University Library houses the world's largest and
			...
			scientific legacy.</p>
		<p>Darwin corresponded with around 2,000 people from all around
			the world and all walks of life. His correspondents included other
		...
		<p>
			Their correspondence began in 1843 when Hooker, just returned from
			James Clark Ross's Antarctic expedition, and already an admirer of
			the older man, was approached about working on Darwin's collection of
			plants from the <i>Beagle</i> voyage. Just the previous year Darwin
			had written out his first coherent account of the main elements of
			his species theory, and within a few months Hooker was admitted into
			the small and select group of those with whom Darwin felt able to
			discuss his emerging ideas. In perhaps his most <a
				href="/view/MS-DAR-00114-00003/4">famous letter of all</a>, Darwin
		...
		<p>
			...
			succeeding months, sent batches of the manuscript of <i>On the
				Origin of Species</i> for comment, and Hooker continued to be a sounding
			board for successive publications.
		</p>
		<p>
			Much of the most important experimental work conducted by Darwin
			after the publication of <i>Origin</i> was on variation and
		...
		<p>
			Hooker was a frequent visitor to Darwin at his home in Downe, Kent,
			and became a great favourite of Darwin's children. The two men shared
			their experience of attending the birth of their children: Darwin <a
				href="/view/MS-DAR-00114-00121/1">advocated the use of
			...
			the <a href="/view/MS-DAR-00101-00159/1">death of his six
				year-old daughter, Maria</a>, knowing that his friend, who had lost both
			a ten year-old daughter and a baby son, would all too clearly
			understand his grief. Those letters are amongst the most poignant in
			the collection.
		</p>
		...
		<p>
			The Cambridge Digital Library, and the <a target="_blank"
				href="http://www.darwinproject.ac.uk/"> Darwin Correspondence
				Project</a>, are very pleased to be able to publish images of almost the
			...
			These are being published simultaneously through CUDL and on the <a
				target="_blank" href="http://www.darwinproject.ac.uk/">The
				Darwin Correspondence Project website</a>.
		</p>
		...
		<p>
			Transcripts of Darwin's letters are normally made available online
			four years after publication in <a target="_blank"
				href="
			http://www.darwinproject.ac.uk/the-correspondence"><i>The
					Correspondence of Charles Darwin</i></a>. We are grateful to <a
				target="_blank"
				href="http://www.cambridge.org/gb/knowledge/series/series_display/item5692679/?site_locale=en_GB">
				Cambridge University Press</a> for allowing us to make available here
			all the texts of the Darwin-Hooker correspondence so far published.
		</p>
		...
		<ul>
			...
			<li><a target="_blank"
				href="http://www.kew.org/science-conservation/collections/joseph-hooker">Sir
					Joseph Dalton Hooker (Kew)</a></li>
			<li><a target="_blank" href="http://www.jdhooker.org.uk/">Joseph
					Dalton Hooker Website</a></li>
			<li><a target="_blank"
