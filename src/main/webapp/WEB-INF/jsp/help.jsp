		...
		<div class="panel light faq">
			...
			<div class="grid_11">
				...
				<ol>
					...
					<li><a href="#cookies"><b>How are cookies are used on
								this site?</b> </a></li>
				</ol>
			</div>
			<div class="grid_11">
				...
				<p>
					...
					planning to provide our data for others to download and use. Please
					<a href="mailto:foundations@lib.cam.ac.uk">let us know</a> what
				...
				<p>
					...
					have a few works online at the moment. You may be able to find what
					you are looking for at the <a
				...
				<div class="searchexample">
					...
					<div>
						<p>
							...
							used as wildcards in your search.<br /> Use <b>?</b> to
				...
				<p>We use these types of cookies to monitor our websites
					performance and how different people use our website. These cookies
					provide us with information that helps us provide a better user
					experience and also to identify any areas that may need
					maintenance.</p>
				...
				<p>
					...
					when you visit a page containing such content, you may be presented
				...
				<p>
					...
					device then you can do this by changing your browser settings. The
					Help function within your browser should tell you how.
					Alternatively, you may wish to visit <a
						href="http://www.aboutcookies.org">www.aboutcookies.org</a>, which
